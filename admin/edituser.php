                                    ...
                                    <form method="POST">
                                        <div class="mb-3">
                                            ...
                                            <input type="text" class="form-control" id="name_221047"
                                                value="<?= $nama ?>" name="nama_lengkap_221047" required>
                                        ...
                                        <div class="mb-3">
                                            ...
                                            <input type="email" class="form-control" id="email_221047"
                                                value="<?= $email ?>" name="email_221047" required>
                                            <div id="emailError" class="error-message">Email tidak valid</div>
                                        </div>
                                        <div class="mb-3">
                                            <label for="phone_221047" class="form-label">Telepon</label>
                                            <input type="text" class="form-control" id="phone_221047"
                                                value="<?= $phone ?>" name="no_hp_221047" required>
                                        ...
                                        <button type="submit" name="simpan" id="submitButton" class="btn btn-primary">Edit</button>
                                    </form>
                                </div>
                            </div>
                        </div>
    ...
    <script>
        document.addEventListener('DOMContentLoaded', function() {
            ...
            function checkFormValidity() {
                ...
                if (isNamaValid && isEmailValid && isPhoneValid && isRoleValid) {
