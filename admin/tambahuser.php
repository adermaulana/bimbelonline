                ...
                <div class="card-body col-6">
                  <form method="POST">
                    ...
                    <div class="mb-3">
                      ...
                      <input type="email" class="form-control" id="email_221047" name="email_221047" required>
                    </div>
                    <div class="mb-3">
                      <label for="phone_221047" class="form-label">Telepon</label>
                      <input type="text" class="form-control" id="phone_221047" name="phone_221047" required>
                    </div>
                    <div class="mb-3">
