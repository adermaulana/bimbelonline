          ...
          <div class="col-md-3">
              <div class="card">
                  <div class="card-body">
                      ...
                      <?php
                      $query_kelas = mysqli_query($koneksi, "SELECT COUNT(*) as total FROM kelas_221047 WHERE id_pengajar_221047 = '$id_pengajar'");
              ...
              <div class="card">
                  <div class="card-body">
                      ...
                      $query_siswa = mysqli_query($koneksi, "SELECT COUNT(DISTINCT id_siswa_221047) as total 
                                                            ...
                                                            WHERE kelas_221047.id_pengajar_221047 = '$id_pengajar'");
          ...
          <div class="col-md-3">
              <div class="card">
                  <div class="card-body">
                      ...
                      <?php
                      $query_jadwal = mysqli_query($koneksi, "SELECT COUNT(*) as total 
                                                            FROM jadwal_221047 
                                                            JOIN kelas_221047 ON jadwal_221047.id_kelas_221047 = kelas_221047.id_221047
                                                            WHERE kelas_221047.id_pengajar_221047 = '$id_pengajar'");
