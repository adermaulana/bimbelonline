...
$query_kelas = mysqli_query(
    $koneksi,
    "SELECT k.*, u.nama_lengkap_221047 as nama_pengajar 
                                        FROM kelas_221047 k 
                ...
                <div class="container-fluid">
                    <div class="card">
                        <div class="card-header">
                            <h5 class="card-title">Tambah Periode untuk Kelas: <?= $data_kelas['nama_kelas_221047'] ?>
                            </h5>
                        ...
                        <div class="card-body">
                            <form method="POST">
                                ...
                                <div class="mb-3">
                                    ...
                                    <input type="number" class="form-control" id="kuota_221047"
                                        name="kuota_221047"required>
                                ...
                                <div class="mb-3">
                                    ...
                                    <input type="date" class="form-control" id="tanggal_mulai_221047"
                                        name="tanggal_mulai_221047" required onchange="updateTanggalSelesai()">
                                </div>
                                ...
                                <div class="mb-3">
                                    ...
                                    <input type="date" class="form-control" id="tanggal_selesai_221047"
                                        name="tanggal_selesai_221047" readonly>
                                </div>
                                ...
                                <button type="submit" id="submitButton" name="simpan_periode"
                                    class="btn btn-primary">Tambah Periode</button>
                                <a href="periode.php?id_kelas=<?= $data_kelas['id_221047'] ?>"
